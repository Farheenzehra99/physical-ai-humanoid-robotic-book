"""Unit tests for ai_agent workflows."""

import pytest
from unittest.mock import Mock, patch
from agents.ai_agent.workflows.base import BaseWorkflow


class TestBaseWorkflow:
    def setup_method(self):
        # Mock route config path
        self.config_path = "../../specs/001-physical-ai-humanoid/contracts/agents/ai_agent-routes.json"
